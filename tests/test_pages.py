...
def test_prose_renders_as_html_not_literal_markdown(client):
    ...
    pipe characters. Checked on the home page because it is the most heavily
    formatted document this site has — the docs pages are deliberately short
    prose wrapped around a live canvas, so a high fence count there would be
    ...
    assert "```" not in body, "a code fence leaked as literal text"
