#!/usr/bin/env python
"""Headless smoke test for the dash-excalidraw documentation site.
...
os.environ.setdefault(
    ...
    os.path.join(tempfile.mkdtemp(prefix="excalidraw-smoke-"), "visitor_analytics.json"),
)
...
def report(res: Results, quiet: bool = False) -> None:
    ...
    print()
    print("=" * width)
    print(f" dash-excalidraw smoke test · Dash {dash.__version__} · Python {sys.version.split()[0]}")
    print("=" * width)
